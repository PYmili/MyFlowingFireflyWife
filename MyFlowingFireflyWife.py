...
from src.methods.threads import *
...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        if self.currentBgImage:
            self.pixmap = QPixmap(self.currentBgImage).scaledToWidth(256)
    ...
    def switchBackground(self, filePath: str) -> None:
        ...
        :return None
        """
        self.pixmap = QPixmap(filePath).scaledToWidth(256)
        self.label.setPixmap(self.pixmap)
        self.label.resize(self.pixmap.size())
        self.label.move(
            (self.width() - self.label.width()) // 2,
    ...
    def startSTTQthread(self) -> None:
        ...
        if self.isStartSTT is True:
            self.FireflysttQThread = sttQThread(loadingSTT(), self.messageQLabel)
